# Support for Output Descriptors in Rincoin Core

Since Rincoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `rin1...` for mainnet or `trin1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Rincoin Core wallets, a convenience function `combo` is
